    ...
    <div className="f-wrapper">
      <div className="container">
        <div className="f-container">
          ...
          <div className="f-menu">
            ...
            <Link to="t-wrapper" spy={true} smooth={true} offset={100}>
             ...
             <a style={{ color: "#fff",fontWeight:"bold", textDecoration: 'none' }} href="/"><span>Home</span></a>
              ...
              <a style={{ color: "#fff", fontWeight: "bold", textDecoration: 'none' }} href="/privacy-policy.html" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
          </div>
          <hr />
          ...
          <hr />
          <h3 className="text" style={{ fontSize: "0.9rem",  color: "rgba(255, 255, 255, 0.332)" }}>
