      ...
      <div className="contact-container">
        ...
        <div className="contact-details">
          <div className="contact-info">
            <h1 className='tag'>Our Office</h1> <br /><br />
            <h2 className='des'>Sarte Solution</h2><br /><br />
            <h2 className='text'>Email: <a href="mailto:info@sartesolution.com">info@sartesolution.com</a></h2><br /><br />
            <h2 className='text'>Phone: <a href="tel:+923038661499">(+92) 303-8661499</a></h2><br /><br />
